...
module hard_main #(
    ...
    parameter code_enable_frequency = 1540 * SAMPLESIZE / 100,
    ...
    parameter data_enable_frequency = 31508400 * SAMPLESIZE / 10000 // Visualization purposes   
) (
    // input wire clock,
