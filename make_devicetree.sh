...
DTFILE="zynq-adrv9364-z7020-fmc.dtb"
CROSS_COMPILE="$3"
...
[ -d "$LINUX_DIR" ] || \
	git clone https://github.com/analogdevicesinc/linux/tree/2023_R2 "$LINUX_DIR"
...
grep -q "CONFIG_GPIO_XILINX=y" arch/arm/configs/zynq_xcomm_adv7511_defconfig || \
    echo "CONFIG_GPIO_XILINX=y" >> arch/arm/configs/zynq_xcomm_adv7511_defconfig
...
[ -z "$DTFILE" ] || \
	...
	mv $DTFILE devicetree.dtb
echo "Exported files: $IMG_NAME, devicetree.dtb to $PWD"
