...
set_property  -dict {PACKAGE_PIN  T15    IOSTANDARD LVCMOS25} [get_ports gpio_rf3]                     ; ## U1,J9,IO_L05_34_JX4_N,JX4,33,RF_GPIO3_BANK34
set_property  -dict {PACKAGE_PIN  T19   IOSTANDARD LVCMOS25} [get_ports gpio_rf4]                     ; ## U1,K10,IO_25_34_JX4,JX4,64,RF_GPIO4_BANK34
set_property  -dict {PACKAGE_PIN  Y18    IOSTANDARD LVCMOS25} [get_ports gpio_rf5]                     ; ## U1,A9,IO_L17_34_JX4_P,JX4,67,RF_GPIO5_BANK34
...
# set_property  -dict {PACKAGE_PIN  V16    IOSTANDARD LVCMOS25} [get_ports fan_pwm]                      ; ## U1,B7,IO_L18_34_JX4_P,JX4,68,FAN_PWM
# set_property  -dict {PACKAGE_PIN  W16    IOSTANDARD LVCMOS25} [get_ports fan_tach]                     ; ## U1,A7,IO_L18_34_JX4_N,JX4,70,FAN_TACH
...
# create_clock -period 4.000 -name ref_clk_0 [get_ports gt_ref_clk_0_p]
# create_clock -period 4.000 -name ref_clk_1 [get_ports gt_ref_clk_1_p]
...
# set_property  -dict {PACKAGE_PIN  U7  IOSTANDARD LVCMOS25} [get_ports gp_out[2]]                    ; ## U1,AC12,IO_L11_SRCC_13_JX2_P,JX3,85,FMC_LA01_CC_P,P2,D8
# set_property  -dict {PACKAGE_PIN  V7  IOSTANDARD LVCMOS25} [get_ports gp_out[3]]                    ; ## U1,AD11,IO_L11_SRCC_13_JX2_N,JX3,87,FMC_LA01_CC_N,P2,D9
# set_property -dict {PACKAGE_PIN W10 IOSTANDARD LVCMOS25} [get_ports {gp_out[4]}]                      ; ## IO_L16_13_JX2_P
# set_property -dict {PACKAGE_PIN W9 IOSTANDARD LVCMOS25} [get_ports {gp_out[5]}]                      ; ## IO_L16_13_JX2_N
