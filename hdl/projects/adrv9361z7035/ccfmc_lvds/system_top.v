...
// 14 ports necessary
  ...
  // Board control, switches/LED/buttons
  // inout   [10:0]  gpio_bd,
  ...
  reg             tx_data_in_p_reg = 5'b1;
  reg             tx_data_in_n_reg = 5'b1;

  // assignments

  // assign fan_pwm = 1'b1;
  // assign hdmi_pd = 1'b0;
  assign tx_data_in_p= tx_data_in_p_reg;
  assign tx_data_in_n = tx_data_in_n_reg;
  ...
  assign gp_in_s[27:0] = gp_out_s[27:0];
