...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(reset, clock, m_axis_ready, m_axis_valid, 
  m_axis_data)
/* synthesis syn_black_box black_box_pad_pin="reset,clock,m_axis_ready,m_axis_valid,m_axis_data[63:0]" */;
  input reset;
  input clock;
  input m_axis_ready;
  output m_axis_valid;
