...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sysid_rom is
  ...
  attribute SOFT_HLUTNM of \rom_data[11]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rom_data[16]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rom_data[19]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rom_data[24]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rom_data[26]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rom_data[31]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rom_data[7]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rom_data[9]_i_2\ : label is "soft_lutpair3";
begin
...
\rom_data[11]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00004000"
    )
        port map (
...
\rom_data[19]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\rom_data[24]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000040"
    )
        port map (
...
\rom_data[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \rom_data[21]_i_2_n_0\,
      I1 => rom_addr(7),
      I2 => \rom_data[5]_i_2_n_0\,
      I3 => rom_addr(4),
      I4 => \rom_data[5]_i_3_n_0\,
      I5 => rom_addr(8),
      O => \rom_data[5]_i_1_n_0\
    );
\rom_data[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000002BA2"
    )
        port map (
      I0 => rom_addr(5),
      I1 => rom_addr(0),
...
\rom_data[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000414"
    )
        port map (
...
\rom_data[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \rom_data[12]_i_2_n_0\,
      I1 => rom_addr(7),
      I2 => \rom_data[9]_i_2_n_0\,
      I3 => rom_addr(4),
      I4 => \rom_data[9]_i_3_n_0\,
      I5 => rom_addr(8),
      O => \rom_data[9]_i_1_n_0\
    );
\rom_data[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00010000"
    )
        port map (
