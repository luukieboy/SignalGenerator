...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sysid_rom is
  ...
  attribute SOFT_HLUTNM of \rom_data[19]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rom_data[20]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rom_data[2]_i_3\ : label is "soft_lutpair0";
...
\rom_data[20]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00100000"
    )
        port map (
...
\rom_data[21]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000054454545"
    )
        port map (
      I0 => rom_addr(6),
      I1 => rom_addr(3),
...
\rom_data[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01000000"
    )
        port map (
...
\rom_data[3]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
