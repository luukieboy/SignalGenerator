...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sysid_rom is
  ...
  attribute SOFT_HLUTNM of \rom_data[26]_i_3\ : label is "soft_lutpair0";
...
\rom_data[10]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00010000"
    )
        port map (
...
\rom_data[11]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000208"
    )
        port map (
